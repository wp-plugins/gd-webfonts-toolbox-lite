...
if (!defined('D4P_VERSION')) { 
    define('D4P_VERSION', '1.4');
    define('D4P_BUILD', '1766');
}
...
if (!function_exists('d4p_include')) {
    /**
     * Load D4P Library file specified by name
     *
     * @param string $name file name, no prefix and extension
     * @param string $directory load from specified sub-folder
...
if (!function_exists('d4p_includes')) {
    /**
     * Load multiple D4P Library files specified by names.
     *
     * @param array $load list of array pairs name/directory
     * @param string $base_path base folder location
     */
