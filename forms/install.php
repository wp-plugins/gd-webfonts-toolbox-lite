...
$_classes = array('d4p-wrap', 'wpv-'.GDWFT_WPV, 'd4p-page-install');
    ...
    <div class="d4p-content">
        <div class="d4p-content-left">
            <div class="d4p-panel-title">
                ...
                <h3><?php _e("Installation", "gd-webfonts-toolbox-lite"); ?></h3>
            </div>
            <div class="d4p-panel-info">
                <?php _e("Before you continue, make sure plugin installation was successful.", "gd-webfonts-toolbox-lite"); ?>
            </div>
        </div>
        <div class="d4p-content-right">
            ...
            <?php
                ...
                _e("Installation completed.", "gd-webfonts-toolbox-lite");
